<template>
    <v-container>
        <v-row class="text-center" style="height: 150vh">
            <v-col cols="12" sm="6">
                <v-img
            ...
            <v-col cols="12" sm="6">
                <GroupCard
                    ...
                    :group="{
                        title: 'Crew',
                        description:
                            'Lorem ipsum dolor sit amet consectetur adipisicing elit. Nisi, cumque. sit amet consectetur adipisicing elit. Nisi, cumque.',
                        tags: [
                            'family',
                            'friends',
                            'family',
